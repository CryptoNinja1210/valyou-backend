    ...
    <div class="">
        ...
        <div>
            ...
            <ul class="nav nav-pills py-3 overflow-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link px-2 w-full text-center song-type {{$key==0?'active': ''}}" data-toggle="pill" href="#home">&nbsp;&nbsp;{{$item}}&nbsp;&nbsp;</a>
                </li>
                @endforeach
            </ul>
        </div>
                    ...
                    <div class="table-responsive table-responsive-web">
                        <table class="table project-list-table table-nowrap table-centered table-borderless">
                            ...
                            <tbody class="tab_3">
                                @for ($i=0; $i<10; $i++)
                                <tr>
                                    <td>{{$i+1}} &nbsp;&nbsp; <img class="k-avatar-sm" src="{{ asset('assets/images/play-button.svg') }}"></td>
                                    <td><img class="k-avatar-md" src="{{ asset('assets/images/player-bg.png') }}"></td>
                                    <td>Started from the bottom</td>
                                    <td><img class="k-avatar-md rounded-circle" src="{{ asset('assets/uploads/artist/1396741054.jpg') }}"></td>
