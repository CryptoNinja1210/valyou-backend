        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="nav nav-tabs tab-select" id="nav-tab" role="tablist" bis_skin_checked="1">
                    ...
                    <?php } else {?>
                    <a href="{{ route('admin.role.switch',['role_id' => 2]) }}" style="color:#A69C9C !important;"> Artist Company Account </a>
    ...
    <div class="card mini-stats-wid wallet">
        <div class="card-body mt-5">
            <div class="media-body text-center" >
                <h2 id="vxd-price" class="mb-0 <?php echo (check_role()!=1)? 'active': '';?>">$ {{ numberformat($wallet) }} VXD</h2>
                <h2 id="artist-price" class="mb-0">$ {{ numberformat($total['artist_total']) }} VXD</h2>
                <h2 id="reserve-price" class="mb-0 <?php echo (check_role()==1)? 'active': '';?>">$ {{number_format($users_reserve_amount,2)}} VXD</h2>
...
<!--                     @if (Session::has('success'))
        ...
        <div class="paymento" style="width: 320px;">
            <input class="mx-auto" type="radio" name="payment_type" value="sell_vxd_credit_card" style="margin-right: 10px !important;"> Fiat (Creditcard)  <img class="col-2" style="width:150px; max-width:170px; float:right;" src="{{asset('assets/images/payment_methods_logos-1.png')}}"> </img> <br>
            <input class="mx-auto mt-3" type="radio" name="payment_type" value="sell_vxd_crypto"  style="margin-right: 10px !important;"> Crypto <img class="col-2" style="margin-top: 10px;width: 120px;max-width: 150px;margin-right: 15px; float:right;" src="{{asset('assets/images/valyuxusdcPayment.png')}}"> </img>
        </div>   
        </div>
