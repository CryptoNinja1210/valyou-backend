	...
	<div class="comment-edit editmodal-content" >
		<div class="comment-body" style="width: 100%;">
			...
			<div class="comment-input">
				<div class="d-flex">
					<img src="{{ URL::asset(auth()->user()->avatar)}}" class="m-auto vatar-md rounded-circle" style="width: 40px; height: 40px;">
				</div>
				...
				<div class="d-flex">
					<img style="transform: rotate(90deg);  width:40px; height:40px" class="m-auto mo-comment-send-btn" data-media="111" src="{{URL::asset('assets/images/valyoux/green_arrow_price_going_up.svg')}}">
				</div>
			</div>
		</div>
	</div>
