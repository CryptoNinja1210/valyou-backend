			...
			<div class="tab-content" id="watchTabContent">
				<div class="tab-pane fade active show p-3" id="nav-watch" role="tabpanel" aria-labelledby="nav-watch-tab" style="display: block">
							...
							<div class="special-video-part">
								...
								<div class="especailly-part">
									...
									<div class="video-detail-info">
										<p>{{@$row->audio_title}}</p>
										<h4>{{@$row->singer}}</h4>
										<h5>Song Valyou: <strong id="valyou-val">${{ numberformat(@$row->artist->stock_value) }}</strong></h5>
										<h5>Stock Price &nbsp;<span></span>&nbsp;<strong class="{{(@$row->artist->stock_value < 0) ?'c-pink': 'c-green'}}"><img class="" width="15" height="15" src="{{(@$row->artist->stock_value < 0) ?'https://testvps.nwlogics.com/public/assets/images/valyoux/pink_arrow_circle_down.svg': 'https://testvps.nwlogics.com/public/assets/images/valyoux/green_arrow_price_going_up.svg'}}">&nbsp;${{ numberformat(@$row->artist->stock_value) }}</strong>&nbsp; - &nbsp;<strong class="{{(@$row->artist->change_stock < 0) ?'c-pink': 'c-green'}}">{{$row->artist->change_stock}}%</strong></h5>
									</div>
								</div>		
								@endforeach
									...
									<div class="show-comment-content-part">
										<div class="show-and-reply-comment-part">
											<div class="comment-body">
												<div class="media">
													<img class="mr-2" src="{{URL::asset('assets/uploads/artist/72921766.jpg')}}" style="width: 32px; height: 32px" alt="logo-img">
							...
							<div class="special-promote-part" >
								<div class="promote-main-body p-3">
									<div class="promote-comment-part">
										<div class="comment-logo-part"  >
											<img src="{{URL::to('public/assets/uploads/artist/72921766.jpg')}}" style="width: 48px; height: 48px" alt="">
											<div class="comment-logo-detail-info">
												<p class="py-auto"><strong>Song Name</strong></p>
											</div>
										</div>	
										<div class="close-promote">
											<img src="{{URL::to('public/assets/images/close_btn.png')}}" class="close_btn" alt="close">
										</div>					
					...
					<div class="personal-info-button-part desktop-detail-info">
						...
						<div class="personal-detail-info">
							<div class="personal-img">			
								<img src="{{asset($artists[0]->photo)}}" style="width: 48px; height: 48px;" alt="">	
							</div>
