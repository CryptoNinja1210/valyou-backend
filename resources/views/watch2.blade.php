				...
				<div class="mo-userinfo">
					...
					<div class="mo-userinfo-content">
						...
						<div class="personel-detail-stock-content">
							<p class="my-auto txt-main" ><b>Stock Price : ${{ numberformat(@$videos[0]->artist->stock_value) }} VXD</b> <img class="" width="15" height="15" src="https://testvps.nwlogics.com/public/assets/images/valyoux/pink_arrow_circle_down.svg"> <b> &nbsp; - &nbsp; 10.77777%</b> </p>
						</div>
						...
						<div class="special-video-part " >
							...
							<div class="especailly-part inline-flex w-full" onclick="selVideoDetail({{$row->id}}, 1)">
								<div class="video-detail-image"  >
									...
									@else
										<video class = "my-video see_video" controlsList="nodownload" width="100%" src="{{ asset($row->name) }}" type="video/mp4" ></video>
									@endif
								</div>
